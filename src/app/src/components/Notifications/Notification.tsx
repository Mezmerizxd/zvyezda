          ...
          <div className="p-4" role="alert" aria-label={title}>
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-shrink-0 flex">
                <button
                  className="bg-background-dark rounded-md inline-flex text-zvyezda-light hover:text-zvyezda-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zvyezda-light"
                  onClick={() => {
                    onDismiss(id);
                  }}
                >
